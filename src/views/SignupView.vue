    ...
    <div class="w-full max-w-md">
      <div class="bg-white rounded-2xl shadow-xl p-8 md:p-10">
        <div class="text-center mb-8">
          ...
          <h1 class="text-gray-900 mb-2">歡迎光臨</h1>
          <p class="text-gray-600">請輸入您的資料來註冊</p>
        </div>

        <VForm class="space-y-6" v-slot="{ errors, meta }" @submit="signup" ref="formRef">
          <div>
          ...
          <div>
            ...
            <ErrorMessage name="姓名" class="text-red-500 text-sm mt-1" />
          </div>
          <button
            type="submit"
      ...
      <p class="text-center mt-6 text-gray-600">
        已經有帳號了？
        <RouterLink to="/" class="text-indigo-600 hover:text-indigo-700">立即登入</RouterLink>
      </p>
    </div>
  </main>
</template>
